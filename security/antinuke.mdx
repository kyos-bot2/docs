...
<AccordionGroup>
  ...
  <Accordion title="Command Detection">
    Whether kyos commands should be counted towards the threshold. (e.g. `,ban`)
...
<AccordionGroup>
  <Accordion title="Punishing members for changing the vanity URL">
    ...
    <Warning>
      kyos can not change the vanity URL back to the original due to Discord limitations.
    </Warning>
    <CodeGroup>
