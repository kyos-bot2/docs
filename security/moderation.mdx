...
<Info>
  The `#jail-log` channel logs all moderation actions done through kyos (e.g.
...
It's important to set the staff roles in your server to ensure that kyos can identify who has dangerous permissions. This is necessary for the `stripstaff` punishment to work.
