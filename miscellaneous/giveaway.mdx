...
<AccordionGroup>
    ...
    <Accordion title="Changing the prize">
        ...
        ```javascript Example
        ,giveaway edit prize .../channels/... kyos whitelist
        ```
        </CodeGroup>
    </Accordion>
...
<AccordionGroup>
    ...
    <Accordion title="Changing the thumbnail">
        ...
        ```javascript Example
        ,giveaway edit thumbnail .../channels/... https://kyos.bot/kyos.png
        ```
    ...
    <Accordion title="Changing the image">
        ...
        ```javascript Example
        ,giveaway edit image .../channels/... https://kyos.bot/kyos.png
        ```
...
<AccordionGroup>
    ...
    <Accordion title="Setting a required level">
        ...
        <Warning>This relies on kyos's [leveling system](/configuration/level-rewards), not other bots.</Warning>
        <CodeGroup>
        ```javascript Syntax
