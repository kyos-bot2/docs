---
title: "Music"
description: "Listen to music within your voice channels."
icon: "music"
---
...
### [**​**](https://kyos-c60486ad.mintlify.app/server/music#setting-the-music-channel)
...
<Frame>
  ![](/images/miscellaneous/music/bind-dj.png)
</Frame>
...
<Frame>
  ![](/images/miscellaneous/music/bind-autoplay.png)
</Frame>
...
<Frame>
  ![](/images/miscellaneous/music/queue.png)
</Frame>
...
<Frame>
  ![](/images/miscellaneous/music/queue-remove.png)
</Frame>

### Moving a track in the queue

Use the `queue move` command to move a track in the queue. You must provide the [current position](#viewing-the-tracks-in-the-queue) and the new position.
...
<Frame>
  ![](/images/miscellaneous/music/queue-move.png)
</Frame>
